...
<head>
    ...
    <title>Input Data Karyawan - Aqua Safe</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <form action="proses_daftar_karyawan.php" method="post" id="karyawanForm">
        ...
        <div class="confirmation" id="confirmation">
            <p>Apakah Anda yakin ingin menambahkan data karyawan?</p>
            <button onclick="submitForm(true)">Ya</button>
            <button onclick="submitForm(false)">Tidak</button>
        </div>
        <button class="back-button" onclick="window.location.href='karyawan.php'">Kembali ke halaman Karyawan</button>
    </div>
